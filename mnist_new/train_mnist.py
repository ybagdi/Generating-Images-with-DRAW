...
params = {
    ...
    'A' : 28,#32 Image width
    'B': 28,#32 Image height
    'z_size' :100,# Dimension of latent space.
    'read_N' : 2,# N x N dimension of reading glimpse.
...
plt.imshow(np.transpose(vutils.make_grid(
    sample_batch[0].to(device)[ : 64], nrow=8, padding=1, normalize=True, pad_value=1).cpu(), (1, 2, 0))) #pad_value=1).cpu()
